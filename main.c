...
/* Доп. функция для контроля. Выводит на экран информацию о bmp файле, 
которая хранится в его заголовках. Для корректной работы не нужна*/
//	print_characts(&file_info, &picture_info);
